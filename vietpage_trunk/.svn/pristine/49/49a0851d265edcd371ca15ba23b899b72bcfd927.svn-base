...
<script>
	...
	<div class="vietpage_container" ><!--Absolute onclick="return askForPermission();"-->
	 	<div class="page"> <!--Static -->
			<div class="vietpage_header" style="position: fixed;top:0; left:0;height: 200px;z-index: 5;background-color: #fff;"><!--Relative -->
				<tiles:insertAttribute name="header"/>
			</div>
			<c:if test="${serviceTypeId != null}">
				<div class="mypagecontent" style="margin-top: 265px;"><!--Relative -->
			</c:if>
			<c:if test="${serviceTypeId == null || serviceTypeId == 0}">
				<div class="mypagecontent" style="margin-top: 200px;"><!--Relative -->
			</c:if>
