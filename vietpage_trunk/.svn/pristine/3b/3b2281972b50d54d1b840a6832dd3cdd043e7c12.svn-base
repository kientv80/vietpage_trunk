...
<div class="vietpage_top_banner">
	...
	<div class="btn-group" style="float: left;">
	   <img title="viet page" alt="viet page" src="/images/vietpage/mobile_menu.png" style="padding: 20px 10px 0px 8px;" data-toggle="dropdown"/>
	  <ul class="dropdown-menu" role="menu" style="width:500px;text-align: left;font-size: 35px;float: right;">
	...
	<div style="position: relative; float: right;width: 20%;">
		<a href="/home" title="Trang chính">
			<img title="viet page logo" alt="viet page logo" alt="" src="/images/vietpage/logo_vietpage.png"/>
		</a>
	</div>
	<div style="position: relative;float: right;width: 60%;padding-top: 60px;margin-right: 40px;">
		<a href="/search" title="Search" style="text-align: left;">
			<input type="text" width="100%" placeholder="Tìm kiếm theo dịch vụ" >
			<img alt="search" src="/images/vietpage/search.png">
		</a>
	</div>
</div>
