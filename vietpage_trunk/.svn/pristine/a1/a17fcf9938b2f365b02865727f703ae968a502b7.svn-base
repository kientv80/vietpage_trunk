...
<form>
	<input type="button" id="btn_addHotNews" value='<s:text name="vietpage.hotnews.add"></s:text>' class="btn btn-primary  btn-xs">
</form>
...
<div id="addHotNews" style="width: 500px;height: 400px">
	<form id="addHotNewsForm" action="/managehotnews" method="post" enctype="multipart/form-data" >
		<table>
			...
			<s:textfield id="title" name="title" key="vietpage.hotnews.title"></s:textfield>
			<s:textarea id="content" name="content" key="vietpage.hotnews.content" cols="50" rows="10"></s:textarea>
...
<div id="editHotNews" style="width: 500px;height: 400px">
	...
	<form id="delHotNewsForm" action="/managehotnews" method="post" >
	</form>
</div>
