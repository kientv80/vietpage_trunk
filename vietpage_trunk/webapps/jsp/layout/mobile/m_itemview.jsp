...
<head>
    ...
    <meta property="og:url"             content="http://vietpage.info/vietpageDetail?type=item&id=${item.id}" /> 
...
<table style="background-color:white;width: 100%;height: 100%;">
	<tr>
		<td>
			<img title="${item.name }" alt="${item.name }"  src="${item.imagePath}" style="width: 100%;">
		</td>
	</tr>
	<tr>
	<td style="vertical-align: top;width: 100%;max-height: 100%;">
		<table  style="background-color:white;width: 100%;"> <!-- Begin item detail -->
				...
				<tr>
					<td colspan="2">
						<div class="fb-comments" data-href="http://vietpage.info/vietpageDetail?type=item&id=${item.id}" data-numposts="5" data-colorscheme="light"></div>
					</td>
					<td>
					</td>
				</tr>
