...
<c:if test="${menuTabs.size() > 0}">
	...
	<ui:PopupWindow panelId="itemViewPanID" width="950" isCentered="false" showPanelButtonId="${buttons}" isVisible="false" containerId="vewItem3" panelTitle="${companyInfo.name }" isRender="true" zIndex="10" isModal="true" dragAble="false" showOkButton="true" okButtonCallBack="assessItem2"></ui:PopupWindow>
<br>
<div>
	<p class="link">
